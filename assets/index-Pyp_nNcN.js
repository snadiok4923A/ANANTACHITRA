...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}}),e[0]=r):r=e[0];let i;return e[1]===t?i=e[2]:(i=(0,X.jsxs)(`div`,{className:`font-sans antialiased bg-[#050505] text-white selection:bg-white selection:text-black min-h-screen`,children:[r,t===`landing`?(0,X.jsx)(xl,{onEnterCollection:()=>{window.scrollTo(0,0),n(`collection`)}}):(0,X.jsx)(Cl,{})]}),e[1]=t,e[2]=i),i}function Tl(e){return(0,X.jsx)(`span`,{className:`text-xs text-zinc-300 uppercase tracking-wider bg-white/10 px-2 py-1 rounded backdrop-blur-sm`,children:e},e)}function El(){return[]}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(wl,{})}));